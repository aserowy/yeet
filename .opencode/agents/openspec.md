...
If your are executing command `/opsx-apply`, implement changes till all tasks are completed. DO NOT STOP and ask anything till all tasks are completed. After all tasks are completed, move to the next step.
